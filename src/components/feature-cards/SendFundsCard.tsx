import { ShoppingCart, ChevronDown, Info, ArrowUpRight } from "lucide-react"
...
export function SendFundsCard() {
  return (
    <div className="rounded-2xl bg-[#141414] border border-[#262626] p-6 flex flex-col">
      ...
      <h3 className="mb-2 text-lg font-semibold text-white">Запросить товар</h3>
      <p className="mb-4 text-sm text-gray-400">Отправь запрос маме или папе — они увидят что тебе нужно и ответят</p>
      ...
      <div className="mt-auto space-y-4 rounded-xl bg-[#1a1a1a] border border-[#262626] p-4">
        <div className="flex items-center justify-between rounded-lg bg-[#0f0f0f] border border-[#262626] px-3 py-2.5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-white">Кому запрос</p>
              <p className="text-xs text-gray-500">Папа / Мама</p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <span className="text-sm text-gray-400">Срочный запрос</span>
        </div>
      </div>
    </div>
  )
